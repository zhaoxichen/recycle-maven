package com.lianjiu.payment.dao.wxh5;
...
public class RequestHandler {
	...
	public RequestHandler(HttpServletRequest request,
		...
		// 验证notify支付订单网关
		this.notifyUrl = "http://orders.lianjiuhuishou.com/orders/WeixinPc/wxRollBack";
...
//		System.out.println("UrlEncode后 packageValue=" + packageValue);
	...
	/*public String createSign(SortedMap<String, String> packageParams) {
		String appKey = this.getKey();
        List<String> signList = new ArrayList<String>();
        Set es = packageParams.entrySet();
        Iterator keys = es.iterator();
        while (keys.hasNext()) {
        ...
        String signs = MD5Util.MD5Encode(sign, this.charset).toUpperCase();
        // String signs = DigestUtils.md5Hex(sign.getBytes()).toUpperCase();
        return signs;
    }*/
