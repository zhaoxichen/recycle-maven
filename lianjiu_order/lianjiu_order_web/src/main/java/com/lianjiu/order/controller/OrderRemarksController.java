...
import com.lianjiu.order.service.OrderRemarksService;
...
public class OrderRemarksController {
	...
	@ResponseBody
	public LianjiuResult getRemarksBySid(@PathVariable String ordersId, @PathVariable int pageNum,
	...
	public LianjiuResult addRemarks(OrdersRemarks remarks) {
		if(null == remarks){
			return LianjiuResult.build(401, "请传入正确的remarks");
		}
